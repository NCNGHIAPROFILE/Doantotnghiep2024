<template>
    <div>
      <v-app-bar app color="error">
        ...
        <v-toolbar-title class="mr-6">Thêm sách số</v-toolbar-title>
        <v-spacer></v-spacer>
        ...
        <v-form v-model="valid" @submit.prevent="submitForm">
          <v-container>
            <v-toolbar color="#82B1FF" class="form-toolbar">
              <v-toolbar-title class="text-center" style="justify-content: center; font-weight:bolder;">Thêm sách Số</v-toolbar-title>
            </v-toolbar>
            <v-row>
              <v-col cols="12" md="4">
                <v-text-field
  ...
  export default {
    ...
    methods: {
        ...
        formData.append('FileName', this.params.file);
        formData.append('Picture', this.params.avatar);
        Request.post("Books/UploadBook", formData)
            .then(response => {
